"""
Django settings for ankup project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-!@z!nlys@ezd-vu%wy0@e*iev6*dtk*2f$__(y0z!(gmn12bwd')
...
WSGI_APPLICATION = 'ankup.wsgi.application'
...
REDIS = {
    ...
    'USER': os.getenv('REDIS_USER', 'redis'),
    'PASSWORD': os.getenv('REDIS_PASSWORD', 'redis'),
    'DB_NUMBER': os.getenv('REDIS_DB_NUMBER', 0)
}
